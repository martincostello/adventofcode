...
namespace MartinCostello.AdventOfCode.Puzzles
{
    ...
    public static class Day25Tests
    {
        ...
        public static void Day25_GenerateCode(ulong value, ulong expected)
        {
            // Act
        ...
        public static void Day25_GetCodeForWeatherMachine(int row, int column, ulong expected)
        {
            // Act
        ...
        [Fact]
        public static void Day25_Solve_Returns_Correct_Solution()
        {
            // Arrange
