...
public sealed class Day16Tests : PuzzleTest
{
    ...
    public void Y2021_Day16_Decode_Returns_Correct_Sum(string transmission, int expected)
    {
        // Act
        (int actual, _) = Day16.Decode(transmission);
    ...
    public async Task Y2021_Day16_Solve_Returns_Correct_Solution()
    {
        ...
        puzzle.Value.ShouldBe(-1); // x > 92676586646
    }
}
