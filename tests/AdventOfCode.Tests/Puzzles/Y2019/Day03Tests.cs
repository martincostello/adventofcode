...
namespace MartinCostello.AdventOfCode.Puzzles.Y2019
{
    ...
    public sealed class Day03Tests : PuzzleTest
    {
        ...
        public void Y2019_Day03_GetManhattanDistanceOfClosesIntersection_Computes_Distance(string[] wires, int expected)
        {
            // Act
            int actual = Day03.GetManhattanDistanceOfClosesIntersection(wires);
        ...
        [Fact]
        public void Y2019_Day03_Solve_Returns_Correct_Solution()
        {
            // Act
