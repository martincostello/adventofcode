    ...
    : IntegrationTest(fixture, outputHelper)
{
    ...
    [PuzzleData(2024, 09, 6395800119709)]
    [PuzzleData(2024, 10, 778, 1925)]
    [PuzzleData(2024, 11, 220722, 261952051690787)]
    [PuzzleData(2024, 12, 1465112)]
    [PuzzleData(2024, 13, 37680, 87550094242995)]
    [PuzzleData(2024, 14, 231782040, 6475)]
    [PuzzleData(2024, 15, 1465152)]
    [PuzzleData(2024, 16, 90440)]
    ...
    [PuzzleData(2025, 5, 761, 345755049374932)]
    [PuzzleData(2025, 6, 5524274308182, 8843673199391)]
    [PuzzleData(2025, 7, 1566, 5921061943075)]
    [PuzzleData(2025, 8, 63920, 1026594680)]
    [UnsolvedPuzzleData(2025, 9, 4759420470)]
    [TooSlowPuzzleData(2025, 10, 524, Puzzle.Unsolved)]
    [TooSlowPuzzleData(2025, 11, 788, Puzzle.Unsolved)]
    [PuzzleData(2025, 12, 536)]
