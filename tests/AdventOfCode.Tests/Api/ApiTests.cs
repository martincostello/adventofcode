...
public class ApiTests : IntegrationTest
{
    ...
    [PuzzleData(2015, 04, new[] { "iwrupvqb" }, 346386, 9958218)]
    ...
    [PuzzleData(2015, 10, new[] { "1321131112" }, 492982, 6989950)]
    [PuzzleData(2015, 11, new[] { "cqjxjnds" }, "cqjxxyzz", "cqkaabcc")]
    ...
    [PuzzleData(2015, 20, new[] { "34000000" }, 786240, 831600)]
    ...
    [PuzzleData(2016, 19, new[] { "5" }, 3, 2)]
    [PuzzleData(2016, 19, new[] { "3014387" }, 1834471, 1420064)]
    ...
    [PuzzleData(2022, 21, 10037517593724, -1)]
