...
%_MSBuild% "%~dp0\AdventOfCode.Day4\AdventOfCode.Day4.sln" /v:minimal /maxcpucount /nodeReuse:false "/p:OutDir=%~dp0\BuildOutput" %* && echo.
"%~dp0\BuildOutput\AdventOfCode.Day4.exe" iwrupvqb && echo.
