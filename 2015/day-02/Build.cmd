...
%_MSBuild% "%~dp0\AdventOfCode.Day2\AdventOfCode.Day2.sln" /v:minimal /maxcpucount /nodeReuse:false "/p:OutDir=%~dp0\BuildOutput" %* && echo.
"%~dp0\BuildOutput\AdventOfCode.Day2.exe" "%~dp0\input.txt" && echo.
