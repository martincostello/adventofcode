...
%_MSBuild% "%~dp0\AdventOfCode.Day3\AdventOfCode.Day3.sln" /v:minimal /maxcpucount /nodeReuse:false "/p:OutDir=%~dp0\BuildOutput" %* && echo.
"%~dp0\BuildOutput\AdventOfCode.Day3.exe" "%~dp0\input.txt" && echo.
